...
import { LibraryArticlePage } from '@project/source/pages/LibraryArticlePage';
...
export default async function Page(properties: PageInterface) {
    ...
    return <LibraryArticlePage libraryNode={serverSideProperties.data} />;
}
